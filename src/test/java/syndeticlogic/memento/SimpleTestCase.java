...
public class SimpleTestCase extends TestCase {
    ...
    public void testSimple() {
        ...
        Cache cache = new LfuCacheTestCase.LfuTestFactory().newInstance(
                "testSimple", 1000, 50);
     ...
     * 
     * Cache cache = new LfuCacheFactory().newInstance(1000, 50); Object object
     * = new Object(); String longString = null;
     * 
