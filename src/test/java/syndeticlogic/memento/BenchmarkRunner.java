...
import syndeticlogic.memento.FifoStrategy;
import syndeticlogic.memento.LfuStrategy;
import syndeticlogic.memento.LruStrategy;
import syndeticlogic.memento.PolicyCache;
import syndeticlogic.memento.ZeroCache;
...
public class BenchmarkRunner {
    ...
    public BenchmarkRunner() throws Exception {
        ...
        Benchmark sequencialRemove = new RemoveBenchmark("S-Rem",
                SEQUENCIAL_KEYS);

        benchmarks = new Benchmark[] { sequencialAdd, sequencialAdd,
                sequencialAdd, //
        ...
        caches = new Cache[] {
                new ZeroCache(), //
                new PolicyCache(new FifoStrategy(null, KEY_COUNT, TIMEOUT_MS),
                        "fifo"), //
                new PolicyCache(new LruStrategy(null, KEY_COUNT, TIMEOUT_MS),
                        "lru"), //
                new PolicyCache(new LfuStrategy(null, KEY_COUNT, TIMEOUT_MS),
                        "lfu") //
        };
    }
